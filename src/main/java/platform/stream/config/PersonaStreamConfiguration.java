...
@ConditionalOnProperty(name="spring.cloud.stream.bindings.personaChannel.enabled", havingValue="true",matchIfMissing=false)
public class PersonaStreamConfiguration {
	...
	@StreamListener(value = MessageSink.PERSONA_CHANNEL)
	public void processPersonaMessage(Message message) {
		try {
